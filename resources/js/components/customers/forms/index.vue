<template>
    <div class="card bg-primary shadow-primary">
        <div class="card-body">
            ...
            <hr>
            <br>
            <form @submit.prevent="handleSubmit('customerForm')" data-vv-scope="customerForm" class="color-form">
                ...
                <div class="form-group">
                    ...
                    <small class="form-text text-danger" v-show="errors.has('customerForm.customer_type')">
                ...
                <div class="form-group ">
                    ...
                    <input 
                        ...
                        name="name" type="text" 
                        class="form-control"
                        id="input-1" placeholder="Enter Customer Name">
                    <small class="form-text text-danger" v-show="errors.has('customerForm.name')">{{
                        errors.first('customerForm.name') }}</small>
                </div>
                <div class="form-group ">
                    <label for="input-1">ID</label>
                    <input v-model="customer.customer_id" v-validate="''" name="customer_id" type="text" class="form-control"
                        id="input-1" placeholder="Enter ID">
                    <small class="form-text text-danger" v-show="errors.has('customerForm.customer_id')">{{
                        errors.first('customerForm.customer_id') }}</small>
                </div>
                <div class="form-group ">
                    <label for="input-1">Course</label>
                    <input v-model="customer.course" v-validate="''" name="course" type="text" class="form-control"
                        id="input-1" placeholder="Enter course">
                ...
                <div class="form-group ">
                    ...
                    <input v-model="customer.year" v-validate="''" name="year" type="text" class="form-control"
                        id="input-1" placeholder="Enter year">
                ...
                <div class="form-group">
                    <button :disabled="isLoading" type="submit" class="btn btn-block bg-white text-primary shadow px-5"><i
                ...
                this.$validator.validateAll(form).then(result => {
                    if (result) {
                        ...
                        if (this.form_type == "NEW_CUSTOMER") {
                            ...
                            this.$store
                                .dispatch("CUSTOMERS_MODULE/STORE_CUSTOMER", customer)
                                .then(() => {
                                    this.isLoading = false;
                                    this.$store.dispatch("CUSTOMERS_MODULE/FETCH_CUSTOMERS");
                                })
                                .catch(errs => {
                                    this.isLoading = false;
                            ...
                            this.$store
                                .dispatch("CUSTOMERS_MODULE/UPDATE_CUSTOMER", customer)
                                .then(() => {
                                    this.isLoading = false;
                                    this.response = [];
