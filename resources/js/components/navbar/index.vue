    ...
    <header class="topbar-nav">
        <nav class="navbar navbar-expand fixed-top gradient-ibiza">
            <ul class="navbar-nav mr-auto align-items-center">
                <li class="nav-item">
                    <a class="nav-link toggle-menu" @click.prevent="handleToggle" href="#">
            ...
            <ul class="navbar-nav align-items-center right-nav-link">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">
                                <a href="javaScript:void();">
                                    <div class="media">
                                        <div class="avatar"><img class="align-self-start mr-3" src="/images/avatars/avatar-1.png"
                                                alt="user avatar"></div>
                            ...
                            <li class="list-group-item">
                                <a href="javaScript:void();">
                                    <div class="media">
                                        <div class="avatar"><img class="align-self-start mr-3" src="/images/avatars/avatar-2.png"
                                                alt="user avatar"></div>
                                        <div class="media-body">
                            ...
                            <li class="list-group-item">
                                <a href="javaScript:void();">
                                    <div class="media">
                                        <div class="avatar"><img class="align-self-start mr-3" src="/images/avatars/avatar-3.png"
                                                alt="user avatar"></div>
                                        <div class="media-body">
                            ...
                            <li class="list-group-item">
                                <a href="javaScript:void();">
                                    <div class="media">
                                        <div class="avatar"><img class="align-self-start mr-3" src="/images/avatars/avatar-4.png"
                                                alt="user avatar"></div>
                                        <div class="media-body">
                ...
                <li class="nav-item">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
                        <span class="user-profile"><img src="/images/avatars/avatar-17.png" class="img-circle"
