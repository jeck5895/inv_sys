                ...
                <ul :class="'pagination pagination-sm justify-content-end'">
                    ...
                    >
                        <a
                            class="page-link"
                            @click.prevent="
                                $emit('first-page', data.first_page_url)
                            "
                            href="#"
                            tabindex="-1"
                        >
                    ...
                    >
                        <a
                            class="page-link"
                            @click.prevent="
                                $emit('prev-page', data.prev_page_url)
                            "
                            href="#"
                            tabindex="-1"
                            >Previous</a
                    ...
                    >
                        <a
                            class="page-link"
                            @click.prevent="
                                $emit('next-page', data.next_page_url)
                            "
                            href="#"
                            >Next</a
                        >
                    ...
                    >
                        <a
                            class="page-link"
                            @click.prevent="
                                $emit('last-page', data.last_page_url)
                            "
                            href="#"
                        >
